...
TYPECHECK_PROJECT_PATHS := config crawlers darknet_search search dashboard vectordb mcp_tools onion_discovery research_orchestrator research_planner research_workers searcher_pipeline evidence_store deep_report scripts
typecheck:
